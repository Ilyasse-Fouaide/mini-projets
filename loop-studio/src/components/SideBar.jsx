...
function SideBar({ isClicked }) {
  return (
    <div className={`fixed flex flex-col divide-y-2 divide-gray-600 justify-between right-0 bg-black w-[300px] h-[89vh] text-right p-6 mt-6 rounded-tl-3xl duration-200 ${isClicked ? 'translate-x-0' : 'translate-x-full'}`}>
      <div>
