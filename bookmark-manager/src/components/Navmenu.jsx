...
function Navmenu({ isClicked }) {
  return (
    <div className={`md:hidden z-10 fixed top-0 w-full h-[100vh] transition-opacity duration-200 ${isClicked ? '' : 'hidden'} bg-indigo-950 divide-y-2 divide-gray-300 pt-24`}>
